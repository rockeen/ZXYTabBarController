...
- (void)viewDidLoad {
    ...
    _tabbar = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, kScreenW, 49)];
    
    _tabbar.image=self.tabbarImage;
...
-(void)createCustomBtn
{
    ...
    [_tabbar addSubview:_selectedView];
...
-(void)btnAct:(ZXYBtn *)btn
{
    ...
    //第一个btn的高亮取消
    ZXYBtn *btnOne= (ZXYBtn *)[_tabbar viewWithTag:100];
